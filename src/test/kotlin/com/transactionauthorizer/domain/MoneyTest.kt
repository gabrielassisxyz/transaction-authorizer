...
class MoneyTest {
    @ParameterizedTest
    @CsvSource("10.50, 1050", "0.01, 1", "0, 0", "1, 100", "1.5, 150", "1E+3, 100000")
    ...
    @Test
    fun `refuses an amount with more than two decimal places`() {
        assertThatThrownBy { Money.ofDecimal(BigDecimal("10.505")) }
